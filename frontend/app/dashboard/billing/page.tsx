  ...
  return (
    <div className="p-4 sm:p-8 space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm sm:text-base text-muted-foreground">Manage your subscription and payment methods</p>
      </div>
      ...
      <GlassCard className="p-6">
        <div className="flex items-start justify-between">
          <div className="space-y-1">
            ...
            <p className="text-sm text-muted-foreground mt-2">$19/month • Billed monthly</p>
          </div>
      ...
      <GlassCard className="p-6">
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={idx} className="flex items-center justify-between py-3 border-b last:border-0" style={{ borderColor: 'var(--glass-border)' }}>
              <div className="flex items-center gap-4">
                <div className="p-2 rounded-lg" style={{ backgroundColor: 'var(--glass-bg)' }}>
      ...
      <GlassCard className="p-6">
        ...
        <div className="flex items-start justify-between">
          ...
          <Button variant="outline" className="hover:bg-[oklch(0.15_0_0)]" style={{ borderColor: 'var(--glass-border)' }}>
            Update
          </Button>
        </div>
      </GlassCard>
