...
export default function LandingPage() {
  return (
    <main>
      ...
      {/* Footer */}
      <footer className="py-12 border-t bg-[oklch(0.10_0_0)]" style={{ borderColor: 'var(--glass-border)' }}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="border-t pt-8" style={{ borderColor: 'var(--glass-border)' }}>
            <div className="flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
              <p>&copy; 2025 Bitslave. All rights reserved.</p>
